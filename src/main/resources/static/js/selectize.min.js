...
!function (a, b) {
    ...
    a.mixin = function (a) {
        a.plugins = {}, a.prototype.initializePlugins = function (a) {
            ...
            if (f.plugins = {
                    ...
                    requested: {},
                    loaded: {}
                }, b.isArray(a))for (c = 0, d = a.length; d > c; c++) {
    ...
    return e.mixin(L), c.mixin(L), a.extend(L.prototype, {
        setup: function () {
            ...
            if (b !== f.lastQuery ? (f.lastQuery = b, d = f.sifter.search(b, a.extend(h, {score: e})), f.currentResults = d) : d = a.extend(!0, {}, f.currentResults), g.hideSelected)for (c = d.items.length - 1; c >= 0; c--) {
            ...
            var c, d, e, f = this;
            if (a.isArray(b))for (c = 0, d = b.length; d > c; c++) {
                f.addOption(b[c]);
        ...
        var c = a.fn.selectize.defaults, d = a.extend({}, c, b), e = d.dataAttr, f = d.labelField, g = d.valueField, h = d.optgroupField, i = d.optgroupLabelField, j = d.optgroupValueField, k = function (b, c) {
            ...
            if (l)for (c.options = JSON.parse(l), h = 0, i = c.options.length; i > h; h++) {
